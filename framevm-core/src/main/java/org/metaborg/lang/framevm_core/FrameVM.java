...
import org.metaborg.lang.framevm_core.vm.vm_force_gc_0_1;
...
import org.metaborg.lang.framevm_core.vm.vm_tick_0_1;
import org.metaborg.lang.framevm_core.vm.vm_tock_0_1;
...
public class FrameVM {
	...
	public static Strategy[] framevmExtend(Strategy[] original) {
		Strategy[] newStrategies = new Strategy[] {  
				...
				vm_tick_0_1.instance,
				vm_tock_0_1.instance,
				vm_force_gc_0_1.instance,
